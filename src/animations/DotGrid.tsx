...
export function DotGrid({
  ...
  const baseRgb = useMemo(() => cssColorToRgb(resolveColor(baseColor)), [baseColor, resolveColor]);
  const activeRgb = useMemo(() => cssColorToRgb(resolveColor(activeColor)), [activeColor, resolveColor]);
  ...
  }, [proximity, baseColor, activeRgb, baseRgb, circlePath, resolveColor]);
  ...
  // Pointer & click events with InertiaPlugin
  useEffect(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
